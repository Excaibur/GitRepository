...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>
	<form id="regform" action="/mem?action=add" method="post" style="margin:0px;">
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
		  ...
		  <tr bgcolor="#F7F3F7">
			...
			<td height="26"><input type="text" name="memberName" size="30" styleClass="textBox"/></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
			<td width="260" height="26" class="text" align="right">登录帐号：</td>
			<td height="26"><input type="text" name="loginName" size="30" styleClass="textBox" onblur="chkLoginName()" /><span id="loginName"></span></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
			<td width="260" height="26" class="text" align="right">登录密码：</td>
			<td height="26"><input type=password id="loginPwd" name="loginPwd" size="30" styleClass="textBox"/></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
			<td width="260" height="26" class="text" align="right">核对密码：</td>
			<td height="26"><input type="password" name="reLoginPwd" size="30" class="textBox"/></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
			<td width="260" height="26" class="text" align="right">联系电话：</td>
			<td height="26"><input type="text" name="phone" size="30" styleClass="textBox"/></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
		  ...
		  <tr bgcolor="#F7F3F7">
			...
			<td height="26"><input type="text" name="zip" size="30" styleClass="textBox"/></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
			<td width="260" height="26" class="text" align="right">电子邮箱：</td>
			<td height="26"><input type="text" name="email" size="30" styleClass="textBox"/></td>
		  </tr>
		  <tr>
			<td height="40" colspan="2" align="center">
				<input type="button" value="注册" onclick="chkReg()"><br>
			</td>
		  </tr>
		</table>
	</form>              	
