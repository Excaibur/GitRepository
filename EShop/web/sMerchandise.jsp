        ...
        <TD height="50" align="right" valign="bottom">
            ...
            <select id="category" name="category">
                <c:if test="${!empty type}">
                    <option value="${typeid}">所有商品</option>
                        ...
                        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#F7F3F7">
                                ...
                                <c:forEach items="${pros}" var="pro">
                                    <tr valign="middle" bgcolor="#FFFFFF">
                                        ...
                                        <td width="160" class="text">
                                            <a href="/def?action=selById&id=${pro.proid}" target=_blank><span
                                                    class="blueText">${pro.proname}</span></a><br>
                                            市场价： ￥${pro.price}<br>
                            ...
                            <tr>
                                <td colspan="4" height="30" bgcolor="#F7F3F7" class="text" align="center">
                                    <a href="/def?action=more&pro=spro&curpage=1" class="blueText"><span class="blueText">首页</span></a>&nbsp;
                                    <a href="/def?action=more&pro=spro&curpage=${curpage-1}" class="blueText"><span class="blueText">上一页</span></a>&nbsp;
                                    <a href="/def?action=more&pro=spro&curpage=${curpage+1}" class="blueText"><span class="blueText">下一页</span></a>&nbsp;
                                    <a href="/def?action=more&pro=spro&curpage=${count}" class="blueText"><span class="blueText">末页</span></a>　
                                    ...
                                    第<span class="redText">${curpage}</span>页/共<span class="redText">${count}</span>页　
