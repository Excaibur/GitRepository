                        ...
                        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#F7F3F7">
                            ...
                            <tr>
                                <td colspan="4" height="30" bgcolor="#F7F3F7" class="text" align="center">
                                    <a href="/def?action=more&pro=pro&curpage=1" class="blueText"><span class="blueText">首页</span></a>&nbsp;
                                    <a href="/def?action=more&pro=pro&curpage=${curpage-1}" class="blueText"><span class="blueText">上一页</span></a>&nbsp;
                                    <a href="/def?action=more&pro=pro&curpage=${curpage+1}" class="blueText"><span class="blueText">下一页</span></a>&nbsp;
                                    <a href="/def?action=more&pro=pro&curpage=${count}" class="blueText"><span class="blueText">末页</span></a>　
